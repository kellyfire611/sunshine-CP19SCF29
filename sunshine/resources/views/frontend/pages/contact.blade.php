            ...
            -->
                    <div class="alert alert-danger" ng-show="contactForm.$invalid">
                        <ul>
                            ...
                            <!-- Thông báo lỗi tel -->
                            <li><span class="error" ng-show="contactForm.tel.$error.required">Vui lòng nhập Số điện thoại</span></li>
                            <li><span class="error" ng-show="contactForm.tel.$error.minlength">Số điện thoại phải >= 9 số</span></li>
                            <li><span class="error" ng-show="contactForm.tel.$error.maxlength">Số điện thoại phải <= 15 số</span></li>
